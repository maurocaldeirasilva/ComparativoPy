...
class Rede(models.Model):
    ...
    conexoes = models.CharField(
        max_length=100, verbose_name=_('Conexões/Aberturas de canais'))
    intelbras_cloud = models.CharField(
        max_length=100, verbose_name=_('Intelbras Cloud'))
    comp_adaptador_wireless = models.CharField(
        max_length=100, verbose_name=_('Compatibilidade com Adaptador Wireless'))
    poe = models.CharField(max_length=100, verbose_name=_('PoE'))
