...
class Geral(models.Model):
    ...
    canais = models.CharField(max_length=100, blank=True, null=True, verbose_name=_('Canais'))
    ...
    quant_hds = models.CharField(max_length=100, blank=True, null=True, verbose_name=_('Quantidade de HDs'))
    capacidade_hd = models.CharField(max_length=100, blank=True, null=True, verbose_name=_('Capacidade do HD'))
    rec_senha = models.CharField(max_length=100, blank=True, null=True, verbose_name=_('Recuperação de Senha'))
