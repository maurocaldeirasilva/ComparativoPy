...
class Imagem(models.Model):
    ...
    taxa_fps = models.CharField(max_length=100, blank=True, null=True, verbose_name=_('Taxa de FPS'))
    comp_luz_fundo = models.CharField(max_length=100, blank=True, null=True, verbose_name=_('Compensação de Luz de Fundo'))
    dori = models.CharField(max_length=100, blank=True, null=True, verbose_name=_('DORI'))
