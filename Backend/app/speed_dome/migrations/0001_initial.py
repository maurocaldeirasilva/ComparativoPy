...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('geral', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='speed_dome.geral', verbose_name='Geral')),
                ('imagem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='speed_dome.imagem', verbose_name='Imagem')),
